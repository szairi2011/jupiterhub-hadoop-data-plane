#!/usr/bin/env bash
# livy-env.sh â€” Environment variables sourced by bin/livy-server at startup.
...
# Livy log directory â€” must be writable by the Livy process (created in Dockerfile)
